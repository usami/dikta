...
- `src/targets/sqlite/`
  ...
  - `validator.ts` — re-exports from postgresql (DB-agnostic)
  - `test.ts` — re-exports from postgresql (DB-agnostic)
- `__tests__/` — topo-sort, ddl, access, validator, test-gen, manifest, generator, dialect, mysql-dialect, mysql-ddl, mysql-access, schema, openapi-schema, openapi-paths, openapi-spec, diagram, seed
